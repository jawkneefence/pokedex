...
export default function Home({monList, fullDex}) {
  ...
  return (
      ...
      <button disabled={!pokemon.next && pageTracker} className="rounded-md h-9 disabled:bg-gray-500 px-3 py-1 mt-3 bg-slate-300" onClick={() => fetchPokemon(pokemon.next, true)}>Next</button>
      </div>
